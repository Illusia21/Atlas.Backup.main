...
export default function ForLiquidation() {
    ...
    useEffect(() => {
        ...
        if (success === 'liquidation') {
            // Remove success param from URL without reload
            window.history.replaceState({}, '', '/liquidation');
    ...
    const filteredRequests = useMemo(() => {
        let requests = allLiquidationRequests;
        ...
        return requests;
    }, [activeTab, searchQuery, activeFilters, sortBy, sortOrder, allLiquidationRequests]);
