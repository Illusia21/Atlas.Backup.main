...
export default function Step3MainLayout() {
  ...
  useEffect(() => {
    ...
    } else if (modeOfPaymentValue === "cheque" && id) {
      navigate(`/reimbursement/step3-cheque/${id}`, { replace: true });
    }
        ...
        <div className="grid grid-cols-[minmax(0,_1fr)_320px] gap-[40px] px-5 items-start">
          ...
          <div className="flex flex-col gap-[60px] mt-[120px]">
            ...
            <div className="grid grid-cols-2 gap-[-900px]">
              <FormField error={errors.pr?.message} className="gap-[6px] w-[487px] font-[700]">
